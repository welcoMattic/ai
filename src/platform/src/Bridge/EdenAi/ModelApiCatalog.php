...
final class ModelApiCatalog extends AbstractModelCatalog
{
    ...
    private ?RuntimeException $discoveryFailure = null;
    ...
    {
        // Discovery is attempted once. A failure is remembered and rethrown rather than retried on
        // every lookup, so an unreachable gateway keeps reporting why instead of degrading into a
        // "model not found" on the second call.
        if (null !== $this->discoveryFailure) {
