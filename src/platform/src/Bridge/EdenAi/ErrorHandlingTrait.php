 ...
 *
 * Note that the published OpenAPI schema (https://api.edenai.run/v3/docs/openapi.json) describes
 * 422 as FastAPI's default "detail: [{loc, msg, type}]" list - its HTTPValidationError - which the
 * API does not actually emit; that form is still parsed defensively.
 *
